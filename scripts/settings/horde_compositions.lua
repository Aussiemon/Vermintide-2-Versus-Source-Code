-- chunkname: @scripts/settings/horde_compositions.lua
...
HordeCompositions = {
	...
	event_chaos_extra_spice_medium = {
		{
			{
				name = "few_clanrats",
				weight = 10,
	...
	event_military_courtyard_plague_monks = {
		{
			{
				name = "mixed",
				weight = 1,
	...
	stronghold_boss_event_defensive = {
		{
			{
				name = "plain",
				weight = 6,
	...
	skittergate_boss_event_defensive = {
		{
			{
				name = "plain",
				weight = 6,
	...
	ai_benchmark_cycle_clanrat_shield = {
		{
			{
				name = "clanrats",
				weight = 3,
	...
	ai_benchmark_cycle_stormvermin_shield = {
		{
			{
				name = "stormvermins",
				weight = 3,
	...
	ai_benchmark_cycle_plague_monks = {
		{
			{
				name = "stormvermins",
				weight = 3,
	...
	ai_benchmark_cycle_chaos_marauder = {
		{
			{
				name = "stormvermins",
				weight = 3,
	...
	ai_benchmark_cycle_chaos_marauder_shield = {
		{
			{
				name = "stormvermins",
				weight = 3,
	...
	ai_benchmark_cycle_chaos_berzerker = {
		{
			{
				name = "stormvermins",
				weight = 3,
	...
	ai_benchmark_cycle_chaos_raider = {
		{
			{
				name = "stormvermins",
				weight = 3,
...
for _, dlc in pairs(DLCSettings) do
	local horde_composition_file = dlc.horde_composition_file

	if horde_composition_file then
		local horde_compositions = dofile(horde_composition_file)

		if horde_compositions then
