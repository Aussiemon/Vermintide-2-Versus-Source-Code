-- chunkname: @scripts/settings/ui_player_portrait_frame_settings.lua

UIPlayerPortraitFrameSettings = {
	positive_reinforcement = {
		{
			layer = 5,
			texture = "portrait_frame_01",
			color = {
				255,
				255,
				255,
	...
	hero_selection = {
		{
			layer = 10,
			texture = "portrait_frame_hero_selection",
			color = {
				255,
				255,
				255,
	...
	frame_skulls_2022 = {
		{
			layer = 10,
			texture = "portrait_frame_skulls_2022",
			color = {
				255,
				255,
				255,
